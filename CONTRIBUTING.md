...
manual downgrade. Its generated source filenames include the package version so cached files from
an earlier release cannot cause checksum failures; packaging-only changes use a bumped `pkgrel`.

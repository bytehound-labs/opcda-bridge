...
Early planning / pre-implementation. Architecture and key dependencies are decided; no code has landed yet.
...
- Scope is intentionally OPC DA only for now — see [`.github/copilot-instructions.md`](.github/copilot-instructions.md) for the reasoning.

...
//! port.
//!
//! This mirrors the pattern `crates/opcda-bridge-client/src/test_support.rs`
//! established in the CLI crate, but is kept as this crate's own copy rather
//! than a shared dependency: `opcda-bridge` must be testable

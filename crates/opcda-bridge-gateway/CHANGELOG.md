...
- _(gateway)_ default namespace-index SQLite commits to batches of 1,024 entries,
  while retaining the configurable commit interval for low-volume inventories.
...
- *(gateway)* add index build telemetry ([#150](https://github.com/bytehound-labs/opcda-bridge/pull/150))

## [0.5.4](https://github.com/bytehound-labs/opcda-bridge/compare/opcda-bridge-gateway-v0.5.3...opcda-bridge-gateway-v0.5.4) - 2026-09-17

### Added

- *(gateway)* support root-scoped namespace traversal ([#146](https://github.com/bytehound-labs/opcda-bridge/pull/146))

## [0.5.3](https://github.com/bytehound-labs/opcda-bridge/compare/opcda-bridge-gateway-v0.5.2...opcda-bridge-gateway-v0.5.3) - 2026-09-17

### Other

- *(deps)* bump bytehound-opc-da-client to 0.3.0 ([#143](https://github.com/bytehound-labs/opcda-bridge/pull/143))

## [0.5.2](https://github.com/bytehound-labs/opcda-bridge/compare/opcda-bridge-gateway-v0.5.1...opcda-bridge-gateway-v0.5.2) - 2026-09-16

### Fixed

- *(gateway)* hold build ownership through native cleanup ([#140](https://github.com/bytehound-labs/opcda-bridge/pull/140))
